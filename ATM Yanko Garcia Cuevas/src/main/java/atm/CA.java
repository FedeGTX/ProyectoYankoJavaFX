...
public static String usuario = "" ;
  ...
  private void generarNumeroAleatorio() {
    ...
    N = String.valueOf(numeroAleatorio);
    jLabel2.setText("Nº identificación: " + N);
}
    ...
    Random random = new Random();
    int numeroIdentificacion = random.nextInt(900) + 100;

    
    int N =  numeroIdentificacion;

    jLabel2.setText("Nº identificación: " + N);

    jButton4.setVisible(true);

    PanelAhorro ventana = new PanelAhorro();
